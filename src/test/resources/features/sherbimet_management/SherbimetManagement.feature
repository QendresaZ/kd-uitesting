Feature: Service Management
  ...
  Scenario: Delete a service
    ...
    Then They should see the list without service with id 1
    ...
    Scenario: View service's details
      ...
      Scenario: Update service
        ...
        When the user updates service with name "Vizite kontrolluese" in the table
        And modifies name to "Kontrolli dhembit"
